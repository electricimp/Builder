...
**Note**: A file included using different paths (even if they point to absolutely the same place) will be treated as different files. E.g., if you include `/a/b/1.nut`, it becomes cached, and then you include `/a/b/../b/1.nut`, it will not be found in the cache.
...
**Note**: A file included using different paths (even if they point to absolutely the same place) will be treated as different files. E.g., if you have saved dependencies for `/a/b/1.nut` and then you include `/a/b/../b/1.nut` - the dependencies will not be applied to this file.
