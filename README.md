...
- Or as a CLI:
  ...
  <pre>
  npm i -g Builder
  pleasebuild [-D<i>&lt;variable&gt;</i> <i>&lt;value&gt;</i>...] [--github-user <i>&lt;username&gt;</i> --github-token <i>&lt;token&gt;</i>] [-l] [--cache] [--clear-cache] [--cache-exclude-list <i>&lt;path_to_file&gt;</i>] <i>&lt;input_file&gt;</i> [--respect-local-includes] [--suppress-duplicate-includes-warning]
  </pre>
  ...
  * <code>--respect-local-includes</code> &mdash; checkout local includes in the github sources from github instead of local.
